var PaySpecialAppClass = (function(app) {
	app.basePath = "mgmt/pay_special/";
	...
	app.init = function() {
		app.mDtTable = $('#dt_list').DataTable($.extend(app.dtConfig,{
			...
			columns : [null, {
				...
				data : 'bonus_percent', render: function(d,t,r){
					var fd = parseFloat(d);
					return fd.toFixed(2);
				}
			},{
				data : 'wash_times', render: function(d,t,r){
					var fd = parseFloat(d);
					return fd.toFixed(2);
				}
			},{
				data : 'min_pay', render: function(d,t,r){
					var fd = parseFloat(d);
					return fd.toFixed(2);
				}
			},{
				data : 'max_pay', render: function(d,t,r){
					var fd = parseFloat(d);
					return fd.toFixed(2);
				}
			}, {
