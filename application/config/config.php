...
$config['sess_cookie_name'] = 'ci_sessions_wa_backend';
$config['sess_expiration'] = 60 * 60 * 24;
$config['sess_save_path'] = 'ci_sessions_backend';//its your table name name
...
|
*/
$config['cookie_prefix']	= 'ci_sessions_vcs_backend';
