<?php
class Bet_record_details_dao extends MY_Model {

	function __construct() {
		parent::__construct();

		// initialize table name
		parent::set_table_name('bet_record_details');
	...
	function find_all_by_bet_record($br_id) {
		// select
		$this -> db -> select('_m.*');
		...
		$this -> db -> where('bet_record_id', $br_id);
