<?php
class Game_tiger_dao extends MY_Model {

	function __construct() {
		parent::__construct();

		// initialize table name
		parent::set_table_name('game_tiger');
	...
	function remove_deprecate() {
		$this -> db -> query("delete from slot_game1_bet_key where TIME_TO_SEC(TIMEDIFF(now(), create_time))  > 10");
	}
