<?php
class Slot_tab_dao extends MY_Model {

	function __construct() {
		parent::__construct();

		// initialize table name
		parent::set_table_name('slot_tab');
	...
	function find_all_active_by_corp_id($corp_id, $hall_id) {
		$sql = "select st.*, IFNULL(stu.user_id, 0) as occupied_user_id from slot_tab st
						left join slot_tab_user stu on stu.tab_id = st.id and stu.hall_id = $hall_id
