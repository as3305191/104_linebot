<?php
class Slot_sun_bet_key_dao extends MY_Model {

	function __construct() {
		parent::__construct();

		// initialize table name
		parent::set_table_name('slot_sun_bet_key');
	...
	function remove_deprecate() {
		$this -> db -> query("delete from slot_sun_bet_key where TIME_TO_SEC(TIMEDIFF(now(), create_time))  > 10");
	}
}
?>
