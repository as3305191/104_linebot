<?php
class Product_strengthen_record_dao extends MY_Model {

	function __construct() {
		parent::__construct();

		// initialize table name
		parent::set_table_name('product_strengthen_record');
	...
	function find_user_level_r($data, $is_count = FALSE) {
