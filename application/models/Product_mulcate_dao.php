<?php
class Product_mulcate_dao extends MY_Model {

	function __construct() {
		parent::__construct();

		// initialize table name
		parent::set_table_name('product_mulcate');
	...
	function find_mulcate($p_id){
		$this -> db -> select('_m.*');
		$this -> db -> select('pc.cate_name as cate_name');
		$this -> db -> join('product_cate as pc','pc.id = _m.product_cateid','left');
		$this -> db -> from("$this->table_name as _m");
