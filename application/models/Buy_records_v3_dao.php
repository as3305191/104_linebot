<?php
class Buy_records_v3_dao extends MY_Model {

	function __construct() {
		parent::__construct();

		// initialize table name
		parent::set_table_name('buy_records_v3');
	...
	function find_valid_records($product_id) {
	...
	function ajax_from_join() {
		// join
		$this -> db -> from("$this->table_name as _m");
		$this -> db -> join("products_v3 p", "p.id = _m.product_id", "left");
