...
class Baccarat_bet_sum extends MY_Mgmt_Controller {

	function __construct() {
		parent::__construct();
		$this -> load -> model('mgmt/Baccarat_tab_round_bet_dao', 'dao');
	...
	public function index()
	{
		...
		$this->load->view('mgmt/baccarat_bet_sum/list', $data);
	}
	...
	public function get_data() {
		...
		$res['items'] = $this -> dao -> sum_ajax($data);
	...
	public function edit($id) {
		...
		$this->load->view('mgmt/baccarat_bet_sum/edit', $data);
	}
