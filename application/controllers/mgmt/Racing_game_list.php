...
class Racing_game_list extends MY_Mgmt_Controller {

	function __construct() {
		parent::__construct();
		$this -> load -> model('Racing_games_dao', 'dao');
	...
	public function index()
	{
		...
		$this->load->view('mgmt/racing_game_list/list', $data);
	}
	...
	public function get_data() {
		...
		$pool_amt = $this -> dao -> sum_pool_by_corp($data['corp_id']);
		$res['pool_amt'] = $pool_amt;
		$res['corp_id'] = $data['corp_id'];
	...
	public function add_pool() {
		$res = array();
		$pool_amt = $this -> get_post('pool_amt');
		...
		$i_data['pool_amt'] = $pool_amt;
		$i_data['status'] = -1; // change pool
	...
	public function edit($id) {
		...
		$this->load->view('mgmt/racing_game_list/edit', $data);
	}
