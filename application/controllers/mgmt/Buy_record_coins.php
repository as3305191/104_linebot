...
class Buy_record_coins extends MY_Base_Controller {
	...
	public function index()
	{
		...
		$this->load->view('mgmt/buy_record_coins/list', $data);
	}
	...
	public function get_data() {
		...
		$items = $this -> transaction_record_coins_dao -> buy_record_coins($data);
