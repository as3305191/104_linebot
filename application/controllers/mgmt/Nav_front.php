...
class Nav_front extends MY_Base_Controller {

	function __construct() {
		parent::__construct();
		$this -> load -> model('Nav_front_dao', 'dao');
	...
	public function index()
	{
		...
		$this->load->view('mgmt/nav_front/list', $data);
	}
	...
	public function edit($id) {
		...
		$this->load->view('mgmt/nav_front/edit', $data);
	}
