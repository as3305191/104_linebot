...
class Fish_table_view extends MY_Base_Controller {
	...
	public function index()
	{
		...
		$this->load->view('mgmt/fish_table_view/list', $data);
	}
	...
	public function get_data() {
		...
		foreach($items as $each) {
			$each -> user_count = $this -> fish_bet_dao -> count_bet_in_seconds($each -> id, 10);
			$each -> user_nick_name = $this -> fish_bet_dao -> count_bet_users_iseconds($each -> id, 10);
			$res['user_nick_name'] = $each -> user_nick_name;
		...
		$res['fish_jp_amt'] = $corp -> fish_jp_amt;
		$this -> to_json($res);
	}
	...
	public function edit($id) {
		...
		$this->load->view('mgmt/fish_table_view/edit', $data);
	}
	...
	public function edit_page() {
		...
		$this->load->view('mgmt/fish_table_view/edit_page', $data);
	}
