...
class Baccarat_bet_record extends MY_Mgmt_Controller {
	...
	public function index()
	{
		...
		$this->load->view('mgmt/baccarat_bet_record/list', $data);
	}
	...
	public function edit($id) {
		...
		$this->load->view('mgmt/baccarat_bet_record/edit', $data);
	}
