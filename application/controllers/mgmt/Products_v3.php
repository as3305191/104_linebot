...
class Products_v3 extends MY_Mgmt_Controller {

	function __construct() {
		parent::__construct();
		$this -> load -> model('Products_v3_dao', 'dao');
	}
	...
	public function index()
	{
		...
		$this->load->view('mgmt/products_v3/list', $data);
	}
	...
	public function edit($id) {
		...
		$this->load->view('mgmt/products_v3/edit', $data);
	}
