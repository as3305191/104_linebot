...
class Buy_record_items extends MY_Base_Controller {
	...
	public function index()
	{
		...
		$this->load->view('mgmt/buy_record_items/list', $data);
	}
	...
	public function get_data() {
		...
		$items = $this -> transaction_record_props_dao -> buy_record_items($data);
