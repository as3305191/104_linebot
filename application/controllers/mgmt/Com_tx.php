...
class Com_tx extends MY_Base_Controller {

	function __construct() {
		parent::__construct();
		$this -> load -> model('Com_tx_dao', 'dao');
	...
	public function index()
	{
		...
		$this->load->view('mgmt/com_tx/tx_list', $data);
	}
	...
	public function edit($id) {
		...
		$this->load->view('mgmt/com_tx/tx_edit', $data);
	}
