...
class Award_center extends MY_Base_Controller {
	...
	public function index()
	{
		...
		$this->load->view('mgmt/award_center/list', $data);
	}
	...
	public function get_data() {
		...
		$items = $this -> ac_dao -> query_ajax($data);

		$res['items'] = $items;
		$res['recordsFiltered'] = $this -> ac_dao -> count_ajax($data);
		$res['recordsTotal'] = $this -> ac_dao -> count_all_ajax($data);
	...
	public function edit($id) {
		...
		$this->load->view('mgmt/award_center/edit', $data);
	}
	...
	public function do_receive() {
		...
		$id = $this -> get_post("id");
		$udata['status']=1;
		$this -> ac_dao -> update_by($udata,'id',$id);
		$this -> to_json($res);
	}
}
