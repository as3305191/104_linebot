...
class Manual extends MY_Mgmt_Controller {
	...
	public function index()
	{
		...
		$data['val'] = $this -> dao -> get_val($data['corp'] -> id);
		$this->load->view('mgmt/manual/list_view', $data);
	}
	...
	public function edit($id) {
		...
		if(!empty($id)) {
			...
			$item = $this -> dao -> get_val_item($s['corp'] -> id);
			$data['item'] = $item;
			$data['val'] = $item -> val;
		}
