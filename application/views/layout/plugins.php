...
<script src="<?= base_url('js/plugin/moment/locale/zh-tw.js') ?>"></script>

<!-- bootstrap.transition / bootstrap.collapse -->
<script src="<?= base_url('js/bootstrap/js/transition.js') ?>"></script>
<script src="<?= base_url('js/bootstrap/js/collapse.js') ?>"></script>

<!-- bootstrap.datetimepicker -->
<script src="<?= base_url('js/plugin/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js') ?>"></script>
...
<!-- back to top -->
<script src="<?= base_url('js/plugin/back-to-top.js')?>"></script>
...
<!-- record -->
<script type="text/javascript" src="<?= base_url('js/plugin/record/recorder.js')?>"></script>
<script type="text/javascript" src="<?= base_url('js/plugin/record/Fr.voice.js')?>"></script>
<!-- <script type="text/javascript" src="<?= base_url('js/plugin/record/libmp3lame.min.js')?>"></script> -->
<!-- <script type="text/javascript" src="<?= base_url('js/plugin/record/mp3Worker.js')?>"></script> -->
...
<!-- CHG USER -->
<script>
function chgUser(userId) {
	$.ajax({
		url: '<?= base_url() ?>' + 'mgmt/users/chg_user',
		type: 'POST',
		data: {
			user_id: userId
		},
