...
<html lang="en-us" id="extr-page">
	...
	<body class="animated fadeInDown smart-style-2">
			...
			<div id="logo-group">
				<span id="logo" style="width:300px;">
					<a href="./">
						...
						<?php endif ?>
						<span style="font-size:20px;">購買頁</span>
					</a>
				</span>
			</div>


			<span id="extr-page-header-space"><a href="<?= base_url('app/#mgmt/buy_products_v3') ?>" class="btn btn-danger">返回</a> </span>
		</header>
