								...
								<table id="dt_list" class="table table-striped table-bordered table-hover" width="100%">
									<thead>
										<tr>
											...
											<th class="min100">匯出帳號</th>
											<th class="min100">接收帳號</th>
...
<script type="text/javascript">
	...
	loadScript(baseUrl + "js/class/BaseAppClass.js", function(){
		loadScript(baseUrl + "js/app/transfer/coin_list.js", function(){
			currentApp = new TransferCoinAppClass(new BaseAppClass({}));
		});
	});
</script>
