									...
									<thead>
										...
										<tr class="search_box">
											    ...
											    <th><input class="form-control input-xs" type="text" /></th>
													<th>
														<select name="agent_type_id" id="agent_type_id" class="form-control">
											    ...
											    <th></th>
											    <th>
														<select name="agent_lv" id="agent_lv" class="form-control">
...
<script type="text/javascript">
	...
	loadScript(baseUrl + "js/class/BaseAppClass.js", function(){
		loadScript(baseUrl + "js/app/agent/list.js", function(){
			currentApp = new AgentAppClass(new BaseAppClass({}));
		});
	});
</script>
