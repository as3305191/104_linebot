...
<script type="text/javascript">
	...
	loadScript(baseUrl + "js/class/BaseAppClass.js", function(){
		loadScript(baseUrl + "js/app/pool_records/list.js", function(){
			currentApp = new PoolRecordsAppClass(new BaseAppClass({}));
