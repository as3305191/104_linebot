...
<div class="header_info">
  <?php if(empty($l_user)): ?>
    <div class="header_info-right unauth ">
        ...
        ?>
        <a id="btn-line-reg" class="" href="https://access.line.me/oauth2/v2.1/authorize?response_type=code&client_id=1620301368&redirect_uri=https://www.winner6869.com/line_callback/lottery_ticket&state=<?= $rand_str ?>&bot_prompt=aggressive&scope=openid%20profile&nonce=<?= $nonce ?>">
  ...
  <?php else: ?>
    <div class="header_info-right auth">
        ...
        <a href="<?=base_url('users/signout')?>" class="btn logout-btn">登出</a>
